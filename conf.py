# -*- coding: utf-8 -*-
#
# StashBundle documentation build configuration file, created by
...
htmlhelp_basename = 'StashBundleDoc'
...
html_theme_options = {
    ...
    "project_nav_name": "Stash Bundle",

    # Set your GitHub user and repo to enable GitHub stars links
    "github_user": "tedious",
    "github_repo": "TedivmStashBundle",

    # Set your Disqus short name to enable comments
    # "disqus_comments_shortname": "my_disqus_comments_short_name",

    # Set you GA account ID to enable tracking
    "google_analytics_account": "UA-51303762-1",
    ...
    "base_url": "http://symfony.stashphp.com",
...
latex_documents = [
  ('contents', 'StashBundle.tex', u'Stash Bundle Documentation',
...
man_pages = [
    ('contents', 'StashBundle', u'Stash Bundle Documentation',
     [u'Robert Hafner'], 1)
]
...
texinfo_documents = [
  ('contents', 'StashBundle', u'Stash Bundle Documentation',
   u'Robert Hafner', 'StashBundle', 'A place to store your cache.',
   'Caching'),
]
